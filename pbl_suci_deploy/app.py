...
# Memaksa tema dasar menjadi Light Mode agar tabel & input tidak berubah hitam di Cloud
st.markdown("""
    <script>
        var elements = window.parent.document.querySelectorAll('[data-testid="stAppViewContainer"]');
...
st.markdown("""
    ...
    /* ================= FORCE WARNA PUTIH PADA INPUT FIELD ================= */
    ...
    /* ================= FORCE WARNA PUTIH & TEXT GELAP PADA TABEL ================= */
    ...
    /* Memaksa background cell di dalam dataframe agar tidak ikut menghitam */
