...
st.markdown("""
    ...
    /* Efek menyala lembut saat input field diklik/aktif */
    ...
    /* ================= DESIGN TOMBOL PREMIUM (DIPERSINGKAT) ================= */
    div.stButton > button:first-child {
        ...
        font-weight: 600 !important;
        font-size: clamp(14px, 3vw, 16px) !important; /* Ukuran teks tombol juga responsif */
        border-radius: 10px !important;
    ...
    .result-value {
        font-size: clamp(28px, 6vw, 38px) !important; font-weight: 800; color: #34D399 !important; margin-top: 5px;
    }
    </style>
...
# TEKS BUTTON DIPERSINGKAT: Agar rapi dan tidak terlalu panjang di smartphone
...
if hitung:
    try:
        ...
        with col_res1:
            st.markdown("#### 🏆 Top 4 Kemungkinan Terbesar")
        ...
        with col_res2:
            st.markdown("#### 📊 Ringkasan Data Masuk")
